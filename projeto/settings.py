...
SECRET_KEY = os.environ.get("SECRET_KEY", "INSECURE")  # noqa: E261, E501
...
LOCALE_PATHS = [
    os.path.join(BASE_DIR, "locale"),  # Caminho para os arquivos de tradução
]
...
JAZZMIN_SETTINGS = {
    ...
    "language": "pt-br",  # Define o idioma em português
